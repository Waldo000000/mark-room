...
`origin/main` is `e8cb0a4` from
[PR #19](https://github.com/Waldo000000/mark-room/pull/19). The latest merged
sequence is:
...
1. Browse validated scenarios from the corpus
2. Add a windward-leeward Rule 11 scenario
